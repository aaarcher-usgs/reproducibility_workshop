...
- plotting 
- R library installation and updating \pause
- Reproduciblity!
...
- Metadata
- Maps or other deliverables \pause
...
\includegraphics[width=4.5in]{images/github_overview_keynote004.png}

## 1: Introduction to RStudio

\includegraphics[width=4.5in]{images/github_overview_keynote005.png}

## 1: Introduction to RStudio

\includegraphics[width=4.5in]{images/github_overview_keynote006.png}

## 1: Introduction to RStudio

\includegraphics[width=4.5in]{images/github_overview_keynote007.png}

## 1: Introduction to RStudio

\includegraphics[width=4.5in]{images/github_overview_keynote008.png}

## 1: Introduction to RStudio

\includegraphics[width=4.5in]{images/github_overview_keynote009.png}

## 1: Introduction to RStudio

\includegraphics[width=4.5in]{images/github_overview_keynote010.png}

## 1: Introduction to RStudio

\includegraphics[width=4.5in]{images/github_overview_keynote011.png}

## 1: Introduction to RStudio

\includegraphics[width=4.5in]{images/github_overview_keynote012.png}
...
Remember to not save .Rdata or history! This is important for ensuring that your code is linear and reproducible (i.e., at the beginning of each script, you load all the data you will need for that entire script - no more, no less!) \pause

- Create a project (using existing, unzipped directory)

Now, your R code pathways will be relatively linked to where that .Rproj file is located. This eases programming and collaboration! \pause
...
- **repository**
    ...
    + All repositories can be made to include more than one "owner" or "collaborator" with direct write privileges \pause
- **branch**
...
- **commit**
    ...
    + Noun: the saved changes as an entity, which can be "pushed" back to the associated branch \pause
- **push**
...
- **pull**
    ...
    + The direction of a pull is from the GitHub server to your local version (RStudio) \pause
- **pull request**
...
## Activity 4: Sync today's Rstudio project with GitHub

1. Add git repository to your RStudio project (in RStudio)
2. Commit all of today's work (in RStudio)
3. Push to GitHub (GitHub and RStudio shell)
    - In GitHub, new repository of **same name** as your project (here: "TWS_reproducibility_workshop")
    - Open RStudio shell (In RStudio, Tools > Shell...)

\small

```{r gitActivity, eval=F, echo=T}
git remote add origin https://github.com/ 
    gitusername/TWS_reproducibility_workshop.git
git config remote.origin.url 
    git@github.com:gitusername/TWS_reproducibility_workshop.git
...
- Excellent GitHub/RStudio tutorial <https://www.r-bloggers.com/rstudio-and-github/>
