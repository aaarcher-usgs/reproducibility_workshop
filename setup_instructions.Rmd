...
8. In RStudio, make sure you select "master" from the dropdown menu that currently says "conduct-rollcall" and you should get a popup message about switching back to the master branch.
